 ...
 * <h1>Possible move in a 3d maze</h1>
 * Represent a possible move in a 3-dimensional maze
 */
public class Maze3dMove {
	 ...
	 */
	public Maze3dMove(Position origin, String direction, Position destination, double cost) {
		this.origin = origin;
